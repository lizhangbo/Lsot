      ...
      [`at-table--border`]: this.border
        ...
        <div class="at-table__content" :style="contentStyle">
            ...
            <div class="at-table__header" v-if="height">
                <table>
                    <colgroup>
                        <col v-for="(column, index) in columnsData" :key="column.key" :width="setCellWidth(column, index)">
                    </colgroup>
            ...
            <div class="at-table__body" :style="bodyStyle">
                <table>
                  ...
                  cursor: column.sortType ? 'pointer' : 'text'
                    ...
                    <template>
                        <tr v-for="(item, index) in sortData" :key="item.seqNo">
                            ...
                            <td v-for="(column) in columns" :key="column.key+'_'+item.seqNo" class="at-table__cell">
                                <template v-if="column.render">
                                    <Cell :item="item" :column="column" :index="index" :render="column.render"></Cell>
                                </template>
                                <template v-if="column.key=='question'">
                                    <a :href="item.url">{{ item[column.key] }}</a>
                                </template>
                                <template v-else>
                                    {{ item[column.key] }}
                                </template>
